...
/**
 * is_chain - a function to test if current char
...
/**
 * check_chain - a function that checks we should
...
/**
 * replace_alias - the function replaces an aliases in the tokenized string
 * @info:  parameter struct
 * Return: 1
 */
